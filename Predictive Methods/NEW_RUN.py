...
if __name__ == '__main__':
    ...
    # ARGPARSE
    #########################
    parser = argparse.ArgumentParser(description='Augmentation Prediction Self-Supervised Learning Framework')

    parser.add_argument('--data_name', required=True, type=str,
        help='Name of the dataset to use for SS training', choices=['FSD50K', 'AS_BAL'])
    ...
    parser.add_argument('--lr', required=True, type=float,
        help='Learning rate of teh training process')
    ...
    experiment_name = params['data']['name'] + '_' + str(params['model']['dims']) + \
